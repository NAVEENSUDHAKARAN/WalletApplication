  ...
  <div class="main-back">
    <div class="container m-auto bg-white p-5 bod-3">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12" id="name">
          ...
          <% double amount= (double) request.getAttribute("taxAmount"); %>
	...
	<%
		try{
			...
			String rechargeType = (String) request.getAttribute("rechargeType");
		...
		%>
	          ...
	          <div class="purchase-section flex-fill flex-vertical">
				...
				<% 
					MobileRecharge mobile = (MobileRecharge) request.getAttribute("rechargeDetails");
				%>
		...
		<%}else if(rechargeType.equals("electricityRecharge")){
          ...
          <div class="purchase-section flex-fill flex-vertical">
			...
			double finalAmount = (double) request.getAttribute("taxAmount");
			%>
            <ul class="purchase-props">
              <li class="flex-between">
		...
		{ %>
          ...
          <div class="purchase-section flex-fill flex-vertical">
			...
			<%
				DTHRecharge recharge = (DTHRecharge) request.getAttribute("dthDetails");
				double finalAmount = (double) request.getAttribute("taxAmount");
			%>
            <ul class="purchase-props">
              <li class="flex-between">
	...
	<%	}
          ...
          <div class="purchase-section flex-fill flex-vertical">
			...
			<%
				WaterRecharge waterRecharge = (WaterRecharge) request.getAttribute("waterRechargeDetails");
				double finalAmount = (double) request.getAttribute("taxAmount");
			%>
            <ul class="purchase-props">
              <li class="flex-between">
	...
	<%
          ...
          <div class="purchase-section flex-fill flex-vertical">
			...
			<%
				GasRecharge gasRecharge = (GasRecharge) request.getAttribute("gasRechargeDetails");
				double finalAmount = (double) request.getAttribute("taxAmount");
			%>
            <ul class="purchase-props">
              <li class="flex-between">
